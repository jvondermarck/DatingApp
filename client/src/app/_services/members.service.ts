...
export class MembersService {
  ...
  getMembers(userParams: UserParams) { // return a Observable<Member[]> 
    ...
    return getPaginatedResult<Member[]>(this.baseUrl + 'users', params, this.http).pipe( // bc it returns an Observable, need to use the pipe method
      map(response => {
  ...
  getLikes(predicate: string, pageNumber, pageSize) {
    ...
    // return this.http.get<Partial<Member[]>>(this.baseUrl + 'likes?predicate=' + predicate); // can be like or likedBy
  }
